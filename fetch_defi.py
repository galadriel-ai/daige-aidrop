...
TOKEN_TRANSFER_URL= "https://pro-api.solscan.io/v2.0/token/defi/activities"
...
def fetch_transfers():
    task_queue = Queue()
    threads = []
    total_pages = 450  # Based on https://solscan.io/token/A9LfgjnWUxujnpud5E3ssKbnNiS1nxRC8Gh74hJTpump
